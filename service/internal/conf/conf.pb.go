...
func (x *Qdrant) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Qdrant) ProtoMessage() {}

func (x *Qdrant) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Qdrant.ProtoReflect.Descriptor instead.
func (*Qdrant) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{1}
}

func (x *Qdrant) GetBaseUrl() string {
	if x != nil {
		return x.BaseUrl
	}
	return ""
...
func (x *Qdrant) GetCollection() string {
	if x != nil {
		return x.Collection
	}
	return ""
...
func (x *Qdrant) GetApiKey() string {
	if x != nil {
		return x.ApiKey
	}
	return ""
...
type Data struct {
	...
	Qdrant        *Qdrant                `protobuf:"bytes,3,opt,name=qdrant,proto3" json:"qdrant,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\"\\\n" +
	"\x06Qdrant\x12\x19\n" +
	"\bbase_url\x18\x01 \x01(\tR\abaseUrl\x12\x1e\n" +
	"\n" +
	"collection\x18\x02 \x01(\tR\n" +
	"collection\x12\x17\n" +
	"\aapi_key\x18\x03 \x01(\tR\x06apiKey\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\x06qdrant\x18\x03 \x01(\v2\x12.kratos.api.QdrantR\x06qdrant\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeoutB\x1fZ\x1dhelloworld/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*Qdrant)(nil),              // 1: kratos.api.Qdrant
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	1,  // 6: kratos.api.Data.qdrant:type_name -> kratos.api.Qdrant
